...
public enum Command {
    ...
    CHANGE_REASON("ab.changeReason",
        ...
        input -> {
            ...
            if (input.getPrimaryData().matches("\\d*")) {
    ...
    public static class CommandInput {
        ...
        public String getPrimary() {
            return this.args.length == 0 ? null : this.args[0];
        }

        String getPrimaryData() {
            return this.getPrimary().toLowerCase();
        }

        public void removeArgument(int index) {
            this.args = ArrayUtils.remove(this.args, index);
        }

        public void next() {
            this.args = ArrayUtils.remove(this.args, 0);
        }
